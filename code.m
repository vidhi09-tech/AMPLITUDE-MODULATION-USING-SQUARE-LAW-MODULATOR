...
%powers
display('signal power of modulated signal')
...
display('noise power added to the modulated signal')
...
display('signal power of demodulated courrupted signal')
signal_power1 = spower(dm1(1:length(t)))
display('VIDHI KUMARI 1841016113')
